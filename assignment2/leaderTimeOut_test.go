...
func TestLeaderTimeout (t *testing.T) {
	...
	exactions := []interface{}{Send{peerId: 2, ev: AppendEntriesReqEv{term: 2, leaderId: 1, prevLogIndex: 0, prevLogTerm: 1, entries: nil, commitIndex: 1}}, Send{peerId: 3, ev: AppendEntriesReqEv{term: 2, leaderId: 1, prevLogIndex: 0, prevLogTerm: 1, entries: nil, commitIndex: 1}}, Send{peerId: 4, ev: AppendEntriesReqEv{term: 2, leaderId: 1, prevLogIndex: 0, prevLogTerm: 1, entries: nil, commitIndex: 1}}, Send{peerId: 5, ev: AppendEntriesReqEv{term: 2, leaderId: 1, prevLogIndex: 0, prevLogTerm: 1, entries: nil, commitIndex: 1}}}
